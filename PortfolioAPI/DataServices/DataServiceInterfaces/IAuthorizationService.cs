...
namespace PortfolioAPI.DataServices.DataServiceInterfaces
{
    /// <summary>
    /// Permissions levels
    /// </summary>
    ...
    public interface IAuthorizationService
    {
        ...
        bool Authorize(string clientKey, PermissionLevel requiredPermissionLevel);
        /// <summary>
        /// Determine whether or not a client is authorized to perform an action
        /// </summary>
        /// <param name="clientKey">The client's identifying key</param>
        ...
        /// <returns>Authorization determinator</returns>
        bool Authorize(string clientKey, List<PermissionLevel> requiredPermissionLevels);
    }
}
